/ * A licença MIT (MIT)
Copyright (c) 2015 CodSec
É garantida a permissão, gratuitamente, para qualquer pessoa obter uma cópia
deste software e arquivos de documentação associada (o "Software"), para lidar
no Software sem restrições, incluindo, sem limitação, os direitos
para usar, copiar, modificar, fundir, publicar, distribuir, sublicenciar e/ou vender
cópias do Software e para permitir que as pessoas a quem o Software é
mobiliado para fazê-lo, nas seguintes condições:
O aviso de copyright acima e este aviso de permissão devem ser incluídas em todos os
cópias ou partes substanciais do Software.
O SOFTWARE É FORNECIDO "COMO ESTÁ", SEM GARANTIA DE QUALQUER TIPO, EXPRESSA OU
IMPLÍCITAS, INCLUINDO MAS NÃO LIMITADO ÀS GARANTIAS DE COMERCIALIZAÇÃO,
ADEQUAÇÃO A UM PROPÓSITO PARTICULAR E NÃO INFRAÇÃO. EM NENHUM CASO A
AUTORES OU TITULARES DE DIREITOS AUTORAIS SERÃO RESPONSÁVEIS POR QUALQUER REIVINDICAÇÃO, DANO OU OUTRO
RESPONSABILIDADE, SEJA EM UMA AÇÃO DE CONTRATO, ATO ILÍCITO OU NÃO, DECORRENTES,
DE OU EM CONEXÃO COM O SOFTWARE OU O USO OU OUTRAS TRANSAÇÕES NA
SOFTWARE.* /
...
// @version     0.1
// @grant       none
// @author      https://www.facebook.com/C0DR00T
// @WebSite     https://www.devhackers.com
// ==/UserScript==
